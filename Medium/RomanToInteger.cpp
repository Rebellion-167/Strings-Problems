...
int convertRomanToInteger(string s) {
    //Creating a map to map roman numerals with numbers
    map<char, int> mpp = {{'I', 1}, {'V', 5}, {'X', 10}, {'L', 50}, {'C', 100}, 
                          {'D', 500}, {'M', 1000}};
    
    int res = 0; //to store the integer equivalent
 ...
 * 
 * Space Complexity : O(1) since we are using a map of constant space
 */